...
if ((profileName != _this select 1) && (_this select 4 < 1)) exitWith {
	hint parseText format ["<t size='1.1'><t size='2'><t color='#f5be00'>Внимание!!!</t></t><br /><br />За вашим ID закреплён другой ник, укажите свой старый ник в профиле игры!<br/><br/>Ваш старый ник<br/> <t size='1.7'><t color='#1dae0e'>%1</t></t><br/><br/>Если у вас проблемы с изменением ника - обратитесь на форум <t color='#665bff'>forum.verum-rp.ru</t></t>",_this select 1];
