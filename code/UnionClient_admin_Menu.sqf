...
_title ctrlsettext format["Verum Life v1.0                 Игроков: %5                 Полиция: %1 | МЧС: %2 | Повстанцы: %3 | Гражданские: %4", west countSide playableUnits, east countSide playableUnits, independent countSide playableUnits, civilian countSide playableUnits, count playableUnits];
