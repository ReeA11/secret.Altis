...
life_process_info = switch (_type) do {
	...
	case "woodrp": {[[["wood",2]],"woodrp","Распил дерева","wood"]};
	...
	case "woodrpf": {[[["woodr",2]],"woodrp","Распил красного дерева","rarewood"]};
...
if (_vendor in _gangResource) then {
	...
	private _valToPay = if (license_civ_sdr or license_reb_aff OR license_reb_arg OR license_reb_nmd OR license_reb_nsb) then {30000} else {2000};
