...
if (typeOf _vehicle in ["O_Truck_03_device_F","DKP_Gelik_SA_e999kx77","DKP_Gelik_SA_gleb","Mrshounka_c63_2015_civ"]) exitWith {hint "Эту технику совсем недавно завезли на остров, поэтому необходимых для перебивки деталей нет. Но всегда можно продать эту малышку на лом..."};
