...
switch (playerSide) do {
	case civilian: {
		...
		player addAction["Начать захват",UnionClient_eventServ_captureServerEvent,"",0,false,false,"",'!isNull cursorTarget && {player distance cursorTarget < 10} && {(typeOf cursorTarget) == "Flag_BI_F"}'];
