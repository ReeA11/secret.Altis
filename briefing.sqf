...
*/
	player createDiaryRecord["changelog",
		[
			"Новости Сервера",
				"Следите за новостями на нашем сайте: verum-rp.ru<br/>"
		]
	...
	player createDiaryRecord ["serverrules",
		[
			"Правила сервера",
				"Внимательно изучите правила сервера на форуме forum.verum-rp.ru<br/><br/>Незнание правил не освобождает от ответственности!"
		]
	];
