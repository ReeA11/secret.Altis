...
class LifeCfgPassports {
	...
	*/
	...
	class bst {
		title = "Argo";
		image = "\union_passports\data\prem\VS.paa";
		side = "civ";
	...
	class aff {
		title = "14K";
		image = "\union_passports\data\prem\passport_14k.paa";
		side = "reb";
	...
	class sdr {
		title = "ASF";
		image = "\union_passports\data\prem\passport_amg.paa";
		side = "civ";
	...
	class nsb {
		title = "TRIADA";
		image = "\union_passports\data\prem\passport_triada.paa";
		side = "reb";
	...
	class mc {
		title = "GHS";
		image = "\union_markers\icons\flag_sdr.paa";
		side = "reb";
	...
	class rfa {
		title = "13";
		image = "\union_passports\data\prem\passport_13.paa";
		side = "reb";
	...
	class fsg {
		title = "IRA";
		image = "\union_markers\icons\flag_la.paa";
		side = "reb";
	...
	class seasonOneWinner {
		...
		image = "\union_passports\prem\passport_season1.paa";
		side = "reb";
