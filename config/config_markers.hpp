...
class LifeCfgMapMarkers {
	class Altis {
		...
		gather[] = {"apple_1","apple_2","apple_3","apple_4","apple_5","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","meth_1","rye_1","yeast_1","hops_1","corn_1","tobacco_1","cotton_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","gas_1","rock_1","uranium1_zone","tree_1","fish_1","fish_2","turtle_zone_1","turtle_zone_2","turtle_zone_3","hunt_zone","hunt_zone_mark","fish_zone","fish_zone_1","turtle_1","turtle_2","turtle_3"};
		base[] = {"marker_603","Argo_base","base_cop_9","base_cop_8","basecg","baseamg","base_hospital_4","base_7news","base_reb_3","base_fedreserve","base_hospital_1","base_hospital_2","base_cop_3","base_cop_pirgos","base_cop_1","base_kpp_kavala","base_nomads","base_mfo_mark","base_reb_2","base_taxi","base_sdr_2","base_cop_jail","base_cop_2","base_kpp_atira","base_reb_1","base_reb_city","base_hospital_3","base_arg_mark","base_sdr_3","base_aff_mark_1","base_mc","base_sdr_1","base_vl","base_nsb","base_mafia","base_nsb_1","base_rfa","base_ira","base_stels_1","base_prok","base_ccp","base_fb","base_hospital_5","base_aff_mark","base_cop_4","base_cop_5","base_cop_6","gov_spawn","base_bst","base_fsg","base_opr","base_cop_7"};
