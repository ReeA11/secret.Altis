	...
	class Altis {
		class Civ {
			...
			class Faj {
				...
				spawnMarker = "seal_spawn";
				icon = "\union_pack\icons\base.paa";
				conditions = "(life_firstTime OR life_newLife) && license_civ_seal";
			};
			class Sdr {
				displayName = "База ASF";
				spawnMarker = "sdr_spawn";
				icon = "\union_pack\icons\base.paa";
				conditions = "(life_firstTime OR life_newLife) && license_civ_sdr";
			};
		...
		class Reb {
			...
			class Aff {
				displayName = "База 14k";
				spawnMarker = "aff_spawn";
				icon = "\union_pack\icons\base.paa";
				conditions = "(life_firstTime OR life_newLife) && license_reb_aff";
			};
			class Nsb {
				displayName = "База TRIADA";
			...
			class Rfa {
				displayName = "База SSG";
				spawnMarker = "rfa_spawn";
				icon = "\union_pack\icons\base.paa";
				conditions = "(life_firstTime OR life_newLife) && license_civ_rfa";
			};
			class Fsg {
				displayName = "База IRA";
