...
class LifeCfgVehTextures {
	...
	class mrp_aff {
		displayName = "AFF";
		texture[] = {"\ads_uniform\textures\1.paa","\ads_uniform\textures\2.paa"};
	};
	class mrp_dnd {
		displayName = "EC";
	...
	class mrp_nsb {
		displayName = "TRD";
		texture[] = {"TRIADA_pack\textures\vehicles\TRIADA_ifrit_front.paa", "TRIADA_pack\textures\vehicles\TRIADA_ifrit_Back.paa"};
	};
	class mrp_7th {
		displayName = "7th";
	...
	class mrp_bst {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\ifrit\1.paa","\asf_uniform\textures\ifrit\2.paa"};
	};
	class mrp_bst2 {
		displayName = "ASF";
		texture[] = {"AMG_uniform\Equipment\ifrit\1.paa","AMG_uniform\Equipment\ifrit\2.paa"};
	};
	class mrp_fsg {
		displayName = "IRA";
	...
	class mrp_seal {
		displayName = "AMGG";
		texture[] = {"AMG\vehicles\IFRITF.paa","AMG\vehicles\IFRITB.paa"};
	};
	class mrp_14 {
		displayName = "14k";
		texture[] = {"\dnd_pack\textures\bhs_ifrit_1.paa","dnd_pack\textures\bhs_ifrit_2.paa"};
	};
	...
	class hmmv_sdr {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\50\noabody_co.paa","\asf_uniform\textures\50\noa_details_2_co.paa"};
	};
	class hmmv_fb {
		displayName = "CSN";
	...
	class hmmv_seal {
		displayName = "SEAL";
		texture[] = {"\MF_pack\data\hmmwv_mf.paa"};
	};
	class hmmv_mercy {
		displayName = "MERCY";
		texture[] = {"\mas_cars\hmmwv\data\hmmwv_body_co.paa"};
	...
	class humm_14 {
		displayName = "14K";
		texture[] = {"\dnd_pack\textures\mh.paa"};
	};
	class humm_fsg {
		displayName = "IRA";
	...
	class humm_seal {
		displayName = "SEAL";
		texture[] = {"\MF_pack\data\heli_light_mf.paa"};
	};
	class humm_bst {
		displayName = "ASF";
		texture[] = {"\union_textures\vip\limousine_sport_monster.paa"};
	...
	class uh1y_CDC {
		displayName = "GHS";
		texture[] = {"fuerte_pack\data\UH1Y.paa"};
	};
	class uh1y_nsb {
		displayName = "NSB";
	...
	class uh1y_bst {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\uh\uh1y_ext_co.paa"};
	};
	class uh1y_bst1 {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\uh\uh1y_ext_co.paa"};
	...
	class uh1y_seal {
		displayName = "AMGG";
		texture[] = {"AMG\vehicles\UH1Y.paa"};
	};
	class uh1y_cg {
		displayName = "CG";
		texture[] = {"\cg_pack\textures\cg_uh.paa"};
	};
	...
	class bmrp_amg {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\hunter\OLV_mrap_01_base_co.paa","\asf_uniform\textures\hunter\OLV_mrap_01_add_co.paa"};
	};
	class bmrp_amg1 {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\hunter\OLV_mrap_01_base_co.paa","\asf_uniform\textures\hunter\OLV_mrap_01_add_co.paa"};
	...
	class strd_seal {
		displayName = "AMGG";
		texture[] = {"AMG\vehicles\STRIDER.paa"};
	};
	class strd_bst {
		displayName = "ASF";
		texture[] = {"\asf_uniform\textures\strider\mrap_03_ext_co.paa"};
	};
	
	class strd_CDC {
		displayName = "GHS";
		texture[] = {"fuerte_pack\data\STRIDER.paa"};
	};
	...
	class ivgt_cdc {
		displayName = "GHS";
		texture[] = {"\fuerte_pack\data\CDC.paa"};
	};
	class ivgt_rw {
