class LifeCfgVehShops {
	...
	class med_shop {
		...
		vehicles[] = {
			...
			{ "ivory_wrx_fastresponse_ems", "" },
			{ "Mrshounka_Volkswagen_Touareg_mcs", "" },
	...
	class civ_car {
		...
		vehicles[] = {
			...
			{ "AMG_Charger_12", "" },
			{ "ext_ivory_supra", "" },
			{ "vovanco_cayenne_dla_zumzik", "(getPlayerUID player) == '76561198023321100'" },
			{ "DKP_Gelik_SA_e999kx77", "(getPlayerUID player) == '76561198253429744'" },
			{ "DKP_Gelik_SA_gleb", "(getPlayerUID player) == '76561198217903119'" },
			{ "Mrshounka_veneno_vovanco", "(getPlayerUID player) == '76561198155885680'" },
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "B_mas_cars_LR_Unarmed", "(call life_donator) > 0" },
			{ "C_Hatchback_01_sport_F", "(call life_donator) > 0" },
			{ "O_MRAP_02_F", "(call life_donator) > 3" },
			{ "ext_Jonzie_XB", "(call life_donator) > 0" }
		};
	};
	...
	class civ_truck {
		...
		vehicles[] = {
			...
			{ "O_Truck_03_device_F", "(call life_donator) > 3" },
	...
	class car_seal {
		side = "civ";
		conditions = "license_civ_seal";
		conditionsMessage = "Необходима лицензия AMG";
		multiplier = 1;
		vehicles[] = {
			{ "B_Heli_Light_01_F", "" },
			{ "EC635_Unarmed", "" },
	...
	class maj_civcar {
		...
		vehicles[] = {
			{ "vovanco_cayenne_dla_zumzik", "(getPlayerUID player) == '76561198023321100'" },
			{ "Lexus570tuned", "(getPlayerUID player) == '76561198284261769'" },
			{ "2000GTRHo", "(getPlayerUID player) == '76561198218996165'" },
			{ "DKP_Gelik_SA_e999kx77", "(getPlayerUID player) == '76561198253429744'" },
			{ "DKP_Gelik_SA_gleb", "(getPlayerUID player) == '76561198217903119'" },
			{ "Mrshounka_veneno_vovanco", "(getPlayerUID player) == '76561198155885680'" }
		};
	...
	class cop_car {
		...
		vehicles[] = {
			...
			{ "JR_CHARGER_POLICE1", "life_coplevel > 2" },// 1
			{ "JR_CROWN_VICTORIA_POLICE1", "life_coplevel > 2" },//2
			{ "JR_IMPALA_POLICE1", "life_coplevel > 2" },//3
			...
			{ "R35Plu", "life_coplevel > 15" },
			{ "Macanlu_civ_P", "life_coplevel > 15" },
			{ "RS6_AvantPlu", "life_coplevel > 15" },
			{ "RS7Plu", "life_coplevel > 15" },
			{ "Chironlu_civ_P", "life_coplevel > 15" },
			{ "A45Plu", "life_coplevel > 15" },
			{ "CLS63lu_civ_P", "life_coplevel > 15" },
	...
	class swat_car {
		...
		vehicles[] = {
			...
			{ "JR_DURANGO_POLICE1", "" },//4
			{ "JR_CHEROKEE_POLICE1", "" },//5
			{ "F12lu_P", "" },//5
			{ "Mrshounka_a3_dodge15_civ", "" },
	...
	class crimi_car {
		...
		vehicles[] = {
			...
			{ "M_Tahoe", "life_coplevel == 20" },
			{ "M_CVPI", "life_coplevel == 20" },
	...
	class sdr_car {
		...
		multiplier = 1;
		vehicles[] = {
			{ "O_MRAP_02_F", "life_civlevel > 1" },
			{ "I_MRAP_03_F", "life_civlevel > 1" },
			{ "B_mas_HMMWV_M2", "life_civlevel > 1" },
			{ "DKP_Gelik_SA_e999kx77", "life_civlevel > 1" },
			{ "B_MRAP_01_F", "life_civlevel > 1" }
		};
	};
	...
	class sdr_air {
		...
		vehicles[] = {
			{ "B_mas_UH1Y_UNA_F", "life_civlevel > 1" },
			{ "B_mas_UH60M_MEV", "life_civlevel > 1" },
			{ "B_Heli_Light_01_F", "life_civlevel > 1" }
		};
	};
	...
	class nsb_car {
		...
		vehicles[] = {
			//{ "O_MRAP_02_F", "life_reblevel > 1" },
			{ "O_MRAP_02_F", "life_reblevel > 1" },
			{ "DKP_Gelik_SA_e999kx77", "life_reblevel > 1" },
			{ "B_mas_HMMWV_M2", "life_reblevel > 1" },
			{ "B_Heli_Light_01_F", "life_reblevel > 1" }
