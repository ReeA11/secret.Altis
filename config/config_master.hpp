...
class LifeCfgSettings {
	...
	life_fuelTrucks[] = {"MV22","B_Truck_01_fuel_F","Alpha_Oil_Corporation_man","B_Truck_01_fuel_CIV_F","O_Truck_02_fuel_F","O_Truck_03_fuel_F","O_Heli_Transport_04_fuel_F","I_mas_cars_Ural_fuel","ext_Jonzie_Tanker_Truck"}; //техника для перевозки нефтепродуктов
	...
	life_gangUpgradeBase = 7000; //базовая стоимость апгрейда базы
	life_gangUpgradeMultipler = 2.5;
	life_gangSlotLimit = 8; //макс кол-во членов обычной банды
	...
	life_cop_min = 2; //минимум копов на сервере
	...
	life_onlyVip4Items[] = {"launch_RPG7V", "RPG7_PG7V"};
	life_onlyVipItems[] = {"arifle_Mk20C_plain_F", "arifle_TRG20_F", "srifle_mas_m110", "LMG_mas_M249_F_d", "LMG_mas_M249_F_v", "LMG_mas_Mk200_F", "MiniGrenade", "arifle_MX_SW_Black_F", "pmc_earpiece", "arifle_MX_SW_F", "LMG_mas_pech_F"};
	...
	life_benchesForCivHumm = "life_gov OR license_civ_sen OR license_civ_vl OR license_civ_vl OR license_civ_led OR license_civ_ira OR license_civ_fb OR license_civ_ccp OR license_civ_ics OR license_civ_bst OR license_civ_ccp"; //условие чтобы не убирались скамейки на хэминге при спауне
	...
	life_dhl_price = 6; //сколько платим за метр
